...
export const FIELD_LABELS: Record<string, string> = {
  ...
  "gateway.cheeko.enabled": "Cheeko Voice Stream Enabled",
  "gateway.cheeko.deepgramApiKey": "Cheeko Deepgram API Key",
  "gateway.cheeko.deepgramModel": "Cheeko Deepgram STT Model",
  "gateway.cheeko.ttsProvider": "Cheeko TTS Provider",
  "gateway.cheeko.openaiApiKey": "Cheeko OpenAI API Key",
  "gateway.cheeko.ttsModel": "Cheeko TTS Model",
  "gateway.cheeko.ttsVoice": "Cheeko TTS Voice",
  "gateway.cheeko.elevenlabsApiKey": "Cheeko ElevenLabs API Key",
  "gateway.cheeko.elevenlabsVoiceId": "Cheeko ElevenLabs Voice ID",
  "gateway.cheeko.elevenlabsModelId": "Cheeko ElevenLabs Model ID",
